...
<meta itemprop="description"
      content="@yield('description', 'Laravel Error Tracking. LaraBug discovers and reports errors, your users do not always report errors, LaraBug does')">
...
@if(!config('larabug.minimal_frontend'))
    <meta name="apple-itunes-app" content="app-id=1184315920">
@endif