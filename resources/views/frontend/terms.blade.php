...
@section('content')
    <div class="pt-8 overflow-hidden mb-8">
        <article class="w-full max-w-6xl mx-auto px-4 mb-4">
            ...
            <p class="pb-4"><strong>Last updated</strong>&nbsp;<strong>February 18, 2020</strong></p>

            <p class="pb-4"><strong>AGREEMENT TO TERMS</strong></p>

            <p class="pb-4">These Terms of Use constitute a legally binding agreement made between you, whether personally or on
                behalf of an entity (“you”) and&nbsp;LaraBug&nbsp;("<strong>Company</strong>", “<strong>we</strong>”,
                “<strong>us</strong>”, or “<strong>our</strong>”), concerning your access to and use of the&nbsp;<a
                        href="https://www.larabug.com">https://www.larabug.com</a>&nbsp;website as well as any other
                media form, media
                ...
                ARE EXPRESSLY PROHIBITED FROM USING THE SITE AND YOU MUST&nbsp;DISCONTINUE USE IMMEDIATELY.<br></p>

            <p class="pb-4">Supplemental terms and conditions or documents that may be posted on the Site from time to time are
                ...
                after the date such revised Terms of Use are posted. &nbsp;</p>

            <p class="pb-4">The information provided on the Site is not intended for distribution to or use by any person or entity
            ...
            <p class="pb-4">The Site is intended for users who are at least 13 years of age. All users who are minors in the
                ...
                parent or guardian read and agree to these Terms of Use&nbsp;prior to you using the
                Site.&nbsp;&nbsp;</p>

            <p class="pb-4"><strong>INTELLECTUAL PROPERTY RIGHTS</strong></p>

            <p class="pb-4">Unless otherwise indicated, the Site is our proprietary property and all source code, databases,
            ...
            <p class="pb-4">Provided that you are eligible to use the Site, you are granted a limited license to access and use the
            ...
            <p class="pb-4"><strong>USER REPRESENTATIONS</strong></p>

            <p class="pb-4">By using the Site, you represent and warrant that:&nbsp;(1)&nbsp;all registration information you submit
                will be true, accurate, current, and complete; (2) you will maintain the accuracy of such information
                and promptly update such registration information&nbsp;as necessary;&nbsp;(3) you have the legal
                capacity and you agree to comply with these Terms of Use;&nbsp;&nbsp;(4)&nbsp;you are not under the age
                of 13;&nbsp;&nbsp;(5) you are not a minor in the jurisdiction in which you reside,&nbsp;or if a minor,
                you have received parental permission to use the Site;&nbsp;(6) you will not access the Site through
                automated or non-human means, whether through a bot, script or otherwise;&nbsp;(7) you will not use the
            ...
            <p class="pb-4">If you provide any information that is untrue, inaccurate, not current, or incomplete, we have the right
                to suspend or terminate your account and refuse any and all current or future use of the Site (or any
                portion thereof). &nbsp;&nbsp;&nbsp; &nbsp; &nbsp;</p>

            <p class="pb-4"><strong>USER REGISTRATION</strong>&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; &nbsp; &nbsp;</p>

            <p class="pb-4">You may be required to register with the Site. You agree to keep your password confidential and will be
            ...
            <p class="pb-4"><strong>FEES AND PAYMENT</strong></p>

            <p class="pb-4">You may be required to purchase or pay a fee to access some of our services. You agree to provide
                ...
                needed. &nbsp;We bill you through an online billing account for purchases made via the Site. Sales tax
                will be added to the price of purchases as deemed required by us. We may change prices at any time. All
                payments shall be in U.S. dollars except for european visitors; these payments will be in EURO.</p>
            <p class="pb-4">You agree to pay all charges or fees at the prices then in effect for your purchases, and you authorize
                us to charge your chosen payment provider for any such amounts upon making your purchase.</p>

            <p class="pb-4">
                All payments are processed with the stripe.com payment processor.
            </p>

            <p class="pb-4">We reserve the right to correct any errors or mistakes in pricing, even if we have already requested or
                received payment. We also reserve the right to refuse any order placed through the Site.&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                &nbsp; &nbsp;</p>

            <p class="pb-4"><strong>CANCELLATION</strong></p>

            <p class="pb-4">All purchases are non-refundable.&nbsp;You can cancel your subscription at any time&nbsp;by contacting us
                using the contact&nbsp;information provided below. Your cancellation will take effect at the end of the
                current paid term.&nbsp;</p>

            <p class="pb-4">If you are unsatisfied with our services, please email us at&nbsp;support@larabug.com&nbsp;or call us at&nbsp;(031)
                622 - 3422.&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>

            <p class="pb-4"><strong>PROHIBITED ACTIVITIES</strong>&nbsp;</p>

            <p class="pb-4">You may not access or use the Site for any purpose other than that for which we make the Site available.
            ...
            <p class="pb-4">As a user of the Site, you agree not to:</p>
            <ol class="pb-4">
            ...
            <p class="pb-4"><strong>SOCIAL MEDIA</strong>&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; &nbsp; &nbsp;</p>

            <p class="pb-4">As part of the functionality of the Site, you may link your account with online accounts you have with
                ...
                Third-Party Account. You represent and warrant that you are entitled to disclose your Third-Party
                ...
                it is available on and through the Site via your account, including without limitation any friend lists
                and (2) we may submit to and receive from your Third-Party Account additional information to the extent
                you are notified when you link your account with the Third-Party Account. Depending on the Third-Party
                ...
                provider, then Social Network Content may no longer be available on and through the Site. You will have
                the ability to disable the connection between your account on the Site and your Third-Party Accounts at
                ...
                acknowledge and agree that we may access your email address book associated with a Third-Party Account
                ...
                contact information below or through your account settings (if applicable). We will attempt to delete
                any information stored on our servers that was obtained through such Third-Party Account, except the
                username and profile picture that become associated with your account.&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>

            <p class="pb-4"><strong>SUBMISSIONS</strong></p>

            <p class="pb-4">You acknowledge and agree that any questions, comments, suggestions, ideas, feedback, or other
            ...
            <p class="pb-4"><strong>THIRD-PARTY WEBSITES AND CONTENT</strong>&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; &nbsp; &nbsp;</p>

            <p class="pb-4">The Site may contain (or you may be sent via the Site) links to other websites ("Third-Party Websites")
            ...
            <p class="pb-4"><strong>U.S. GOVERNMENT RIGHTS</strong></p>

            <p class="pb-4">Our services are “commercial items” as defined in Federal Acquisition Regulation (“FAR”) 2.101. If our
                ...
                software) and FAR 12.211 (for technical data). If our services are acquired by or on behalf of any
                agency within the Department of Defense, our services are subject to the terms of these Terms of Use in
            ...
            <p class="pb-4"><strong>SITE MANAGEMENT</strong></p>

            <p class="pb-4">We reserve the right, but not the obligation, to: (1) monitor the Site for violations of these Terms of
            ...
            <p class="pb-4"><strong>PRIVACY POLICY</strong>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;</p>

            <p class="pb-4">We care about data privacy and security. Please review our Privacy Policy:&nbsp;<strong>https://www.larabug.com/privacy-policy</strong>.
                By using the Site, you agree to be bound by our Privacy Policy, which is incorporated into these Terms
                of Use. Please be advised the Site is hosted in the United States. If you access the Site from the
                European Union, Asia, or any other region of the world with laws or other requirements governing
                personal data collection, use, or disclosure that differ from applicable laws in the United States, then
                through your continued use of the Site,&nbsp;you are transferring your data to the United States, and
                you expressly consent to have your data transferred to and processed in the United States.&nbsp;Further,
            ...
            <p class="pb-4"><strong>TERM AND TERMINATION</strong></p>

            <p class="pb-4">These Terms of Use shall remain in full force and effect while you use the Site. WITHOUT LIMITING ANY
            ...
            <p class="pb-4">If we terminate or suspend your account for any reason, you are prohibited from registering and creating
            ...
            <p class="pb-4"><strong>MODIFICATIONS AND INTERRUPTIONS</strong></p>

            <p class="pb-4">We reserve the right to change, modify, or remove the contents of the Site at any time or for any reason
            ...
            <p class="pb-4">We cannot guarantee the Site will be available at all times. We may experience hardware, software, or
            ...
            <p class="pb-4"><strong>GOVERNING LAW</strong></p>

            <p class="pb-4">These Terms of Use and your use of the Site are governed by and construed in accordance with the laws of&nbsp;the
                State&nbsp;of&nbsp;__________&nbsp;applicable to agreements made and to be entirely performed within&nbsp;the
                State of&nbsp;__________, without regard to its conflict of law principles.&nbsp;&nbsp;</p>

            <p class="pb-4"><strong>DISPUTE RESOLUTION</strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp; &nbsp;</p>

            <p class="pb-4"><strong>Binding Arbitration</strong></p>

            <p class="pb-4">If the Parties are unable to resolve a Dispute through informal negotiations, the Dispute (except those
                ...
                in person, through the submission of documents, by phone, or online. The arbitrator will make a decision
                in writing, but need not provide a statement of reasons unless requested by either Party. The arbitrator
                ...
                in&nbsp;The Netherlands&nbsp;County,&nbsp;Nijkerk. Except as otherwise provided herein, the Parties may
                litigate in court to compel arbitration, stay proceedings pending arbitration, or to confirm, modify,
                vacate, or enter judgment on the award entered by the arbitrator.</p>

            <p class="pb-4">If for any reason, a Dispute proceeds in court rather than arbitration, the Dispute shall be commenced or
                prosecuted in the state and federal courts located&nbsp;in&nbsp;The Netherlands&nbsp;County,&nbsp;Amsterdam,
                and the Parties hereby consent to, and waive all defenses of lack of personal jurisdiction, and forum
                non conveniens with respect to venue and jurisdiction in such state and federal courts. Application of
                the United Nations Convention on Contracts for the International Sale of Goods and the the Uniform
                Computer Information Transaction Act (UCITA) are excluded from these Terms of Use. &nbsp;&nbsp;&nbsp;&nbsp;
                &nbsp; &nbsp;</p>


            <p class="pb-4">If this provision is found to be illegal or unenforceable, then neither Party will elect to arbitrate any
            ...
            <p class="pb-4"><strong>Restrictions</strong></p>

            <p class="pb-4">The Parties agree that any arbitration shall be limited to the Dispute between the Parties individually.
            ...
            <p class="pb-4"><strong>Exceptions to Arbitration</strong>&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;</p>

            <p class="pb-4">The Parties agree that the following Disputes are not subject to the above provisions concerning binding
            ...
            <p class="pb-4"><strong>CORRECTIONS</strong></p>

            <p class="pb-4">There may be information on the Site that contains typographical errors, inaccuracies, or omissions,
            ...
            <p class="pb-4">THE SITE IS PROVIDED ON AN AS-IS AND AS-AVAILABLE BASIS. YOU AGREE THAT YOUR USE OF THE SITE AND OUR
            ...
            <p class="pb-4"><strong>LIMITATIONS OF LIABILITY</strong></p>

            <p class="pb-4">IN NO EVENT WILL WE OR OUR DIRECTORS, EMPLOYEES, OR AGENTS BE LIABLE TO YOU OR ANY THIRD PARTY FOR ANY
                ...
                BEEN ADVISED OF THE POSSIBILITY OF SUCH DAMAGES.&nbsp;NOTWITHSTANDING&nbsp;ANYTHING TO THE CONTRARY
                CONTAINED HEREIN, OUR LIABILITY TO YOU FOR ANY CAUSE WHATSOEVER AND REGARDLESS OF THE FORM OF THE
                ACTION, WILL AT ALL TIMES BE LIMITED TO&nbsp;THE AMOUNT PAID,&nbsp;IF ANY, BY YOU TO US.&nbsp;CERTAIN
                STATE LAWS DO NOT ALLOW LIMITATIONS ON IMPLIED WARRANTIES OR THE EXCLUSION OR LIMITATION OF CERTAIN
                DAMAGES. IF THESE LAWS APPLY TO YOU, SOME OR ALL OF THE ABOVE DISCLAIMERS OR LIMITATIONS MAY NOT APPLY
                TO YOU, AND YOU MAY HAVE ADDITIONAL RIGHTS.&nbsp;&nbsp;</p>

            <p class="pb-4"><strong>INDEMNIFICATION</strong></p>

            <p class="pb-4">You agree to defend, indemnify, and hold us harmless, including our subsidiaries, affiliates, and all of
            ...
            <p class="pb-4"><strong>USER DATA</strong></p>

            <p class="pb-4">We will maintain certain data that you transmit to the Site for the purpose of managing the performance
            ...
            <p class="pb-4"><strong>ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES</strong></p>

            <p class="pb-4">Visiting the Site, sending us emails, and completing online forms constitute electronic communications.
            ...
            <p class="pb-4"><strong>CALIFORNIA USERS AND RESIDENTS</strong></p>

            <p class="pb-4">If any complaint with us is not satisfactorily resolved, you can contact the Complaint Assistance Unit of
            ...
            <p class="pb-4"><strong>MISCELLANEOUS</strong></p>

            <p class="pb-4">These Terms of Use and any policies or operating rules posted by us on the Site or in respect to the Site
                ...
                Use and the lack of signing by the parties hereto to execute these Terms of Use.</p>

            <p class="pb-4"><strong>CONTACT US</strong></p>

            <p class="pb-4">In order to resolve a complaint regarding the Site or to receive further information regarding use of the
                Site, please contact us at:&nbsp;</p>

            <p class="pb-4"><strong>LaraBug</strong>&nbsp;&nbsp;&nbsp;&nbsp;</p>
            <p class="pb-4"><strong>__________&nbsp;&nbsp;&nbsp;</strong></p>
            <p class="pb-4"><strong>support@larabug.com</strong></p>
        </article>
    </div>
@endsection
