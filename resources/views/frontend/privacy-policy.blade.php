        ...
        <article class="w-full max-w-6xl mx-auto px-4 mb-4">
            <h1 class="text-3xl leading-tight tracking-tighter font-medium mb-4">
                @yield('title')
                        ...
                        <p class="pb-4">We are very delighted that you have shown interest in our enterprise. Data protection is of a
                            particularly
                            high priority for the management of the LaraBug. The use of the Internet pages of the LaraBug is possible
                            without
                            any indication of personal data; however, if a data subject wants to use special enterprise services via
                            our
                        ...
                        <p class="pb-4">The processing of personal data, such as the name, address, e-mail address, or telephone number of a data
                            subject shall always be in line with the General Data Protection Regulation (GDPR), and in accordance
                            with
                            the country-specific data protection regulations applicable to the LaraBug. By means of this data
                            protection
                            declaration, our enterprise would like to inform the general public of the nature, scope, and purpose of
                            the
                        ...
                        <p class="pb-4">As the controller, the LaraBug has implemented numerous technical and organizational measures to ensure the
                            most
                        ...
                        <h4 class="font-bold pb-4">1. Definitions</h4>
                        <p class="pb-4">The data protection declaration of the LaraBug is based on the terms used by the European legislator for the
                        ...
                        <p class="pb-4">In this data protection declaration, we use, inter alia, the following terms:</p>

                        <ul style="list-style: none">
                            <li><h4 class="font-bold pb-4">a)    Personal data</h4>
                                <p class="pb-4">Personal data means any information relating to an identified or identifiable natural person
                                    (“data
                            ...
                            <li><h4 class="font-bold pb-4">b) Data subject</h4>
                                <p class="pb-4">Data subject is any identified or identifiable natural person, whose personal data is processed
                                    by
                                    the controller responsible for the processing.</p>
                            </li>
                            <li><h4 class="font-bold pb-4">c)    Processing</h4>
                                <p class="pb-4">Processing is any operation or set of operations which is performed on personal data or on sets
                                    of
                            ...
                            <li><h4 class="font-bold pb-4">d)    Restriction of processing</h4>
                                <p class="pb-4">Restriction of processing is the marking of stored personal data with the aim of limiting their
                                    processing in the future. </p>
                            </li>
                            <li><h4 class="font-bold pb-4">e)    Profiling</h4>
                                <p class="pb-4">Profiling means any form of automated processing of personal data consisting of the use of
                                    personal
                            ...
                            <li><h4 class="font-bold pb-4">f)     Pseudonymisation</h4>
                                <p class="pb-4">Pseudonymisation is the processing of personal data in such a manner that the personal data can
                                    no
                            ...
                            <li><h4 class="font-bold pb-4">g)    Controller or controller responsible for the processing</h4>
                                <p class="pb-4">Controller or controller responsible for the processing is the natural or legal person, public
                            ...
                            <li><h4 class="font-bold pb-4">h)    Processor</h4>
                                <p class="pb-4">Processor is a natural or legal person, public authority, agency or other body which processes
                                    personal data on behalf of the controller. </p>
                            </li>
                            <li><h4 class="font-bold pb-4">i)      Recipient</h4>
                                <p class="pb-4">Recipient is a natural or legal person, public authority, agency or another body, to which the
                            ...
                            <li><h4 class="font-bold pb-4">j)      Third party</h4>
                                <p class="pb-4">Third party is a natural or legal person, public authority, agency or body other than the data
                            ...
                            <li><h4 class="font-bold pb-4">k)    Consent</h4>
                                <p class="pb-4">Consent of the data subject is any freely given, specific, informed and unambiguous indication of
                                    the
                        ...
                        <h4 class="font-bold pb-4">2. Name and Address of the controller</h4>
                        <p class="pb-4">Controller for the purposes of the General Data Protection Regulation (GDPR), other data protection laws
                            applicable in Member states of the European Union and other provisions related to data protection is:

                        </p>

                        <p class="pb-4">LaraBug</p>
                        <p class="pb-4">Melkrijder 4E</p>
                        <p class="pb-4">3861SG Nijkerk</p>
                        <p class="pb-4">Netherlands</p>
                        <p class="pb-4">Email: support@larabug.com</p>
                        <p class="pb-4">Website: https://www.larabug.com</p>

                        <h4 class="font-bold pb-4">3. Cookies</h4>
                        <p class="pb-4">The Internet pages of the LaraBug use cookies. Cookies are text files that are stored in a computer system
                            via
                            an Internet browser.</p>

                        <p class="pb-4">Many Internet sites and servers use cookies. Many cookies contain a so-called cookie ID. A cookie ID is a
                        ...
                        <p class="pb-4">Through the use of cookies, the LaraBug can provide the users of this website with more user-friendly
                            services
                            that would not be possible without the cookie setting.</p>

                        <p class="pb-4">By means of a cookie, the information and offers on our website can be optimized with the user in mind.
                            ...
                            cart in
                            an online shop. The online store remembers the articles that a customer has placed in the virtual
                            shopping
                            cart via a cookie.</p>

                        <p class="pb-4">The data subject may, at any time, prevent the setting of cookies through our website by means of a
                        ...
                        <h4 class="font-bold pb-4">4. Collection of general data and information</h4>
                        <p class="pb-4">The website of the LaraBug collects a series of general data and information when a data subject or
                            automated
                            ...
                            sub-websites,
                            (5) the date and time of access to the Internet site, (6) an Internet protocol address (IP address), (7)
                            the
                            Internet service provider of the accessing system, and (8) any other similar data and information that
                            may
                            be used in the event of attacks on our information technology systems.</p>

                        <p class="pb-4">When using these general data and information, the LaraBug does not draw any conclusions about the data
                            subject.
                            ...
                            information
                            technology systems and website technology, and (4) provide law enforcement authorities with the
                            information
                            necessary for criminal prosecution in case of a cyber-attack. Therefore, the LaraBug analyzes anonymously
                            ...
                            process.
                            The anonymous data of the server log files are stored separately from all personal data provided by a
                            data
                            subject.</p>

                        <h4 class="font-bold pb-4">5. Registration on our website</h4>
                        <p class="pb-4">The data subject has the possibility to register on the website of the controller with the indication of
                        ...
                        <p class="pb-4">By registering on the website of the controller, the IP address—assigned by the Internet service provider
                        ...
                        <p class="pb-4">The registration of the data subject, with the voluntary indication of personal data, is intended to
                            enable
                        ...
                        <p class="pb-4">The data controller shall, at any time, provide information upon request to each data subject as to what
                        ...
                        <h4 class="font-bold pb-4">6. Contact possibility via the website </h4>
                        <p class="pb-4">The website of the LaraBug contains information that enables a quick electronic contact to our enterprise,
                            as
                            well as direct communication with us, which also includes a general address of the so-called electronic
                            mail
                            (e-mail address). If a data subject contacts the controller by e-mail or via a contact form, the
                            personal
                            data transmitted by the data subject are automatically stored. Such personal data transmitted on a
                            voluntary
                            basis by a data subject to the data controller are stored for the purpose of processing or contacting
                            the
                            data subject. There is no transfer of this personal data to third parties.</p>

                        <h4 class="font-bold pb-4">7. Routine erasure and blocking of personal data</h4>
                        <p class="pb-4">The data controller shall process and store the personal data of the data subject only for the period
                        ...
                        <p class="pb-4">If the storage purpose is not applicable, or if a storage period prescribed by the European legislator or
                            another competent legislator expires, the personal data are routinely blocked or erased in accordance
                            with
                            legal requirements.</p>

                        <h4 class="font-bold pb-4">8. Rights of the data subject</h4>
                        <ul style="list-style: none;">
                            <li><h4 class="font-bold pb-4">a) Right of confirmation</h4>
                                <p class="pb-4">Each data subject shall have the right granted by the European legislator to obtain from the
                            ...
                            <li><h4 class="font-bold pb-4">b) Right of access</h4>
                                <p class="pb-4">Each data subject shall have the right granted by the European legislator to obtain from the
                                ...
                                <p class="pb-4">Furthermore, the data subject shall have a right to obtain information as to whether personal
                                    data
                                ...
                                <p class="pb-4">If a data subject wishes to avail himself of this right of access, he or she may, at any time,
                                    contact any employee of the controller.</p>
                            </li>
                            <li><h4 class="font-bold pb-4">c) Right to rectification </h4>
                                <p class="pb-4">Each data subject shall have the right granted by the European legislator to obtain from the
                                ...
                                <p class="pb-4">If a data subject wishes to exercise this right to rectification, he or she may, at any time,
                                    contact
                                    any employee of the controller.</p></li>
                            <li>
                                <h4 class="font-bold pb-4">d) Right to erasure (Right to be forgotten) </h4>
                                <p class="pb-4">Each data subject shall have the right granted by the European legislator to obtain from the
                                ...
                                <p class="pb-4">If one of the aforementioned reasons applies, and a data subject wishes to request the erasure of
                                    personal data stored by the LaraBug, he or she may, at any time, contact any employee of the
                                    controller. An employee of LaraBug shall promptly ensure that the erasure request is complied with
                                    immediately.</p>

                                <p class="pb-4">Where the controller has made personal data public and is obliged pursuant to Article 17(1) to
                                    erase
                                    ...
                                    processing is
                                    not required. An employees of the LaraBug will arrange the necessary measures in individual
                                    cases.</p>
                            </li>
                            <li><h4 class="font-bold pb-4">e) Right of restriction of processing</h4>
                                <p class="pb-4">Each data subject shall have the right granted by the European legislator to obtain from the
                                ...
                                <p class="pb-4">If one of the aforementioned conditions is met, and a data subject wishes to request the
                                    restriction
                                    of the processing of personal data stored by the LaraBug, he or she may at any time contact any
                                    employee of the controller. The employee of the LaraBug will arrange the restriction of the
                                    processing. </p>
                            </li>
                            <li><h4 class="font-bold pb-4">f) Right to data portability</h4>
                                <p class="pb-4">Each data subject shall have the right granted by the European legislator, to receive the
                                    personal
                                ...
                                <p class="pb-4">Furthermore, in exercising his or her right to data portability pursuant to Article 20(1) of the
                                ...
                                <p class="pb-4">In order to assert the right to data portability, the data subject may at any time contact any
                                    employee of the LaraBug.</p>

                            </li>
                            <li>
                                <h4 class="font-bold pb-4">g) Right to object</h4>
                                <p class="pb-4">Each data subject shall have the right granted by the European legislator to object, on grounds
                                ...
                                <p class="pb-4">The LaraBug shall no longer process the personal data in the event of the objection, unless we can
                                ...
                                <p class="pb-4">If the LaraBug processes personal data for direct marketing purposes, the data subject shall have
                                    the
                                    ...
                                    subject objects to the LaraBug to the processing for direct marketing purposes, the LaraBug will no
                                    longer
                                    process the personal data for these purposes.</p>

                                <p class="pb-4">In addition, the data subject has the right, on grounds relating to his or her particular
                                    situation,
                                    to object to processing of personal data concerning him or her by the LaraBug for scientific or
                                ...
                                <p class="pb-4">In order to exercise the right to object, the data subject may contact any employee of the LaraBug.
                                    In
                            ...
                            <li><h4 class="font-bold pb-4">h) Automated individual decision-making, including profiling</h4>
                                <p class="pb-4">Each data subject shall have the right granted by the European legislator not to be subject to a
                                ...
                                <p class="pb-4">If the decision (1) is necessary for entering into, or the performance of, a contract between the
                                    data subject and a data controller, or (2) it is based on the data subject's explicit consent,
                                    the
                                    LaraBug shall implement suitable measures to safeguard the data subject's rights and freedoms and
                                    legitimate interests, at least the right to obtain human intervention on the part of the
                                    controller,
                                    to express his or her point of view and contest the decision.</p>

                                <p class="pb-4">If the data subject wishes to exercise the rights concerning automated individual
                                    decision-making, he
                                    or she may, at any time, contact any employee of the LaraBug.</p>

                            </li>
                            <li><h4 class="font-bold pb-4">i) Right to withdraw data protection consent </h4>
                                <p class="pb-4">Each data subject shall have the right granted by the European legislator to withdraw his or her
                                    consent to processing of his or her personal data at any time. </p>

                                <p class="pb-4">If the data subject wishes to exercise the right to withdraw the consent, he or she may, at any
                                    time,
                                    contact any employee of the LaraBug.</p>

                            </li>
                        </ul>
                        <h4 class="font-bold pb-4">9. Data protection provisions about the application and use of Facebook</h4>
                        <p class="pb-4">On this website, the controller has integrated components of the enterprise Facebook. Facebook is a
                            social
                            network.</p>

                        <p class="pb-4">A social network is a place for social meetings on the Internet, an online community, which usually
                            allows
                        ...
                        <p class="pb-4">The operating company of Facebook is Facebook, Inc., 1 Hacker Way, Menlo Park, CA 94025, United States.
                            If a
                            person lives outside of the United States or Canada, the controller is the Facebook Ireland Ltd., 4
                            Grand
                            Canal Square, Grand Canal Harbour, Dublin 2, Ireland.</p>

                        <p class="pb-4">With each call-up to one of the individual pages of this Internet website, which is operated by the
                            controller and into which a Facebook component (Facebook plug-ins) was integrated, the web browser on
                            the
                            ...
                            of
                            this technical procedure, Facebook is made aware of what specific sub-site of our website was visited by
                            the
                            data subject.</p>

                        <p class="pb-4">If the data subject is logged in at the same time on Facebook, Facebook detects with every call-up to our
                            website by the data subject—and for the entire duration of their stay on our Internet site—which
                            specific
                            sub-site of our Internet page was visited by the data subject. This information is collected through the
                            Facebook component and associated with the respective Facebook account of the data subject. If the data
                            subject clicks on one of the Facebook buttons integrated into our website, e.g. the "Like" button, or if
                            the
                            data subject submits a comment, then Facebook matches this information with the personal Facebook user
                            account of the data subject and stores the personal data.</p>

                        <p class="pb-4">Facebook always receives, through the Facebook component, information about a visit to our website by the
                            data subject, whenever the data subject is logged in at the same time on Facebook during the time of the
                            call-up to our website. This occurs regardless of whether the data subject clicks on the Facebook
                            component
                            or not. If such a transmission of information to Facebook is not desirable for the data subject, then he
                            or
                            she may prevent this by logging off from their Facebook account before a call-up to our website is
                            made.</p>

                        <p class="pb-4">The data protection guideline published by Facebook, which is available at
                            ...
                            subject
                            to eliminate a data transmission to Facebook.</p>

                        <h4 class="font-bold pb-4">10. Data protection provisions about the application and use of Google Analytics (with anonymization
                            function)</h4>
                        <p class="pb-4">On this website, the controller has integrated the component of Google Analytics (with the anonymizer
                        ...
                        <p class="pb-4">The operator of the Google Analytics component is Google Inc., 1600 Amphitheatre Pkwy, Mountain View, CA
                            94043-1351, United States.</p>

                        <p class="pb-4">For the web analytics through Google Analytics the controller uses the application "_gat. _anonymizeIp".
                            By
                            ...
                            Contracting State to the Agreement on the European Economic Area.</p>

                        <p class="pb-4">The purpose of the Google Analytics component is to analyze the traffic on our website. Google uses the
                            ...
                            our
                            Internet site for us.</p>

                        <p class="pb-4">Google Analytics places a cookie on the information technology system of the data subject. The definition
                            of
                            cookies is explained above. With the setting of the cookie, Google is enabled to analyze the use of our
                            website. With each call-up to one of the individual pages of this Internet site, which is operated by
                            the
                        ...
                        <p class="pb-4">The cookie is used to store personal information, such as the access time, the location from which the
                            access
                            was made, and the frequency of visits of our website by the data subject. With each visit to our
                            Internet
                            site, such personal data, including the IP address of the Internet access used by the data subject, will
                            be
                            transmitted to Google in the United States of America. These personal data are stored by Google in the
                            United States of America. Google may pass these personal data collected through the technical procedure
                            to
                            third parties.

                        </p>

                        <p class="pb-4">The data subject may, as stated above, prevent the setting of cookies through our website at any time by
                            ...
                            Google Analytics may be deleted at any time via a web browser or other software programs.</p>

                        <p class="pb-4">In addition, the data subject has the possibility of objecting to a collection of data that are generated
                            by
                            ...
                            may
                            not be transmitted to Google Analytics. The installation of the browser add-ons is considered an
                            objection
                            by Google. If the information technology system of the data subject is later deleted, formatted, or
                            newly
                            installed, then the data subject must reinstall the browser add-ons to disable Google Analytics. If the
                            browser add-on was uninstalled by the data subject or any other person who is attributable to their
                            sphere
                            of competence, or is disabled, it is possible to execute the reinstallation or reactivation of the
                            browser
                            add-ons.</p>

                        <p class="pb-4">Further information and the applicable data protection provisions of Google may be retrieved under
                            https://www.google.com/intl/en/policies/privacy/ and under
                            http://www.google.com/analytics/terms/us.html.
                            Google Analytics is further explained under the following Link https://www.google.com/analytics/.</p>

                        <h4 class="font-bold pb-4">11. Data protection provisions about the application and use of Twitter</h4>
                        <p class="pb-4">On this website, the controller has integrated components of Twitter. Twitter is a multilingual,
                            ...
                            including those who are not logged on to Twitter. The tweets are also displayed to so-called followers
                            of
                            the respective user. Followers are other Twitter users who follow a user's tweets. Furthermore, Twitter
                            allows you to address a wide audience via hashtags, links or retweets.</p>

                        <p class="pb-4">The operating company of Twitter is Twitter, Inc., 1355 Market Street, Suite 900, San Francisco, CA
                            94103,
                            UNITED STATES.</p>

                        <p class="pb-4">With each call-up to one of the individual pages of this Internet site, which is operated by the
                            controller
                            ...
                            https://about.twitter.com/de/resources/buttons. During the course of this technical procedure, Twitter
                            gains
                            knowledge of what specific sub-page of our website was visited by the data subject. The purpose of the
                            integration of the Twitter component is a retransmission of the contents of this website to allow our
                            users
                            to introduce this web page to the digital world and increase our visitor numbers.</p>

                        <p class="pb-4">If the data subject is logged in at the same time on Twitter, Twitter detects with every call-up to our
                            website by the data subject and for the entire duration of their stay on our Internet site which
                            specific
                            ...
                            information to the personal Twitter user account of the data subject and stores the personal data.</p>

                        <p class="pb-4">Twitter receives information via the Twitter component that the data subject has visited our website,
                            provided that the data subject is logged in on Twitter at the time of the call-up to our website. This
                            occurs regardless of whether the person clicks on the Twitter component or not. If such a transmission
                            of
                            information to Twitter is not desirable for the data subject, then he or she may prevent this by logging
                            off
                            from their Twitter account before a call-up to our website is made.</p>

                        <p class="pb-4">The applicable data protection provisions of Twitter may be accessed under
                            https://twitter.com/privacy?lang=en.</p>

                        <h4 class="font-bold pb-4">12. Legal basis for the processing </h4>
                        <p class="pb-4">Art. 6(1) lit. a GDPR serves as the legal basis for processing operations for which we obtain consent for
                            a
                        ...
                        <h4 class="font-bold pb-4">13. The legitimate interests pursued by the controller or by a third party</h4>
                        <p class="pb-4">Where the processing of personal data is based on Article 6(1) lit. f GDPR our legitimate interest is to
                            carry out our business in favor of the well-being of all our employees and the shareholders.</p>

                        <h4 class="font-bold pb-4">14. Period for which the personal data will be stored</h4>
                        <p class="pb-4">The criteria used to determine the period of storage of personal data is the respective statutory
                            retention
                        ...
                        <h4 class="font-bold pb-4">15. Provision of personal data as statutory or contractual requirement; Requirement necessary to enter
                            into
                            a contract; Obligation of the data subject to provide the personal data; possible consequences of
                            failure to
                            provide such data </h4>
                        <p class="pb-4">We clarify that the provision of personal data is partly required by law (e.g. tax regulations) or can
                            also
                        ...
                        <h4 class="font-bold pb-4">16. Existence of automated decision-making</h4>
                        <p class="pb-4">As a responsible company, we do not use automatic decision-making or profiling.</p>
        </article>
    </div>
@endsection
