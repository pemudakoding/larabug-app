        ...
        <div class="flex flex-col w-full md:w-72 text-white bg-primary-900 flex-shrink-0 md:h-screen md:sticky md:top-0">
          <div class="flex-shrink-0 p-4 flex flex-row items-center justify-between space-y-1">
            ...
            <NavList class="md:block" :isopen=open :is-active="route().current()">
              ...
              <NavListItem @click="open = false" href="/panel/projects" :is-active="route().current('panel.projects.*')" :isopen="open">
                <template #icon>
                  <svg
                      class="w-6 h-6 text-primary-400"
                      fill="none"
              ...
              <NavListItem @click="open = false" href="/panel/profile" :is-active="route().current('panel.profile.*')" :isopen="open">
                <template #icon>
                  <svg
                      class="w-6 h-6 text-primary-400"
                      fill="none"
